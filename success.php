  ...
  <meta http-equiv="refresh" content="0.2; url='tg://join?invite=XkE1zJEHQe0yM2Ey'" />
 <script>
    ...
    <img src="img/LogoBig_1x.png" alt="">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <!-- Заголовок канала -->
          <h1 class="jumbotron-heading">🚀ANGEL TRADE🚀</h1>
          <!-- Описание, укажите здесь то, что замотивирует человека подписаться -->
          <p style="display:block" class="lead text-muted">👋 Привет, меня зовут Angel! 
✅ Я помогу тебе обрести финансовую свободу🔥

Набор людей в лучшее закрытое комьюнити по трейдингу ⚡️
Подать заявку: @AngeltradeFxx 👨‍💻

Торгуем тут 👉 https://pocket1.click/smart/sxePmwGTYCN7Jk</p>
          <p>
